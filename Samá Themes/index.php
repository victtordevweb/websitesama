...
<body>
                        ...
                        <nav class="navbar navbar-expand-lg">
                            ...
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                <ul class="navbar-nav ml-auto">
                                    ...
                                    <li class="nav-item"><a class="page-scroll" href="#about">Sobre a Samá</a></li>
                                    ...
                                    <li class="nav-item"><a class="" href="javascript:void(0);">Documentação</a></li>
            ...
            <div class="container">
                <div class="row align-items-top">
                    <div class="col-xl-5 col-lg-6">
                        <div class="header-content-right mt-100">
                            <small class="sub-title">Agência Digital</small>
                            <h1 class="title">Samá</h1>
                            <p>*Focada em desenvolvimento de temas</p>
    ...
    <section id="about" class="about-area pt-60 pb-60">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    <div class="section-title text-center">
                        <h2 class="title">Sobre a Samá</h2>
                        <p>A <b>Samá</b> é uma uma empresa especializada em desenvolvimento de Temas para E-Commerce com a idéia desenvolver projetos de loja <b>moderno,</b> <b>clean</b> e <b>bonito</b> baseado em técnicas UX para tornar o acesso e navegação do cliente mais fácil e objetiva <b>elevando a sua conversão</b></p>
                    </div> <!-- section title -->
                </div>
            </div> <!-- row -->
        </div> <!-- container -->
    ...
    <section id="differentials" class="differentials-area gray-bg pt-60 pb-60">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-4 col-md-6 col-sm-8">
                    <div class="single-service text-center mt-30">
                        ...
                        <div class="service-content">
                            <h4 class="service-title"><a href="#">Experiência Única</a></h4>
                            <p>Curabitur vitae magna felis. Nulla ac libero ornare, vestibulum lacus quis blandit enimdicta sunt.</p>
                        </div>
                    </div> <!-- single service -->
                </div>
                <div class="col-lg-4 col-md-6 col-sm-8">
                    <div class="single-service text-center mt-30">
                        ...
                        <div class="service-content">
                            <h4 class="service-title"><a href="#">Suporte 24/7</a></h4>
                            <p>Curabitur vitae magna felis. Nulla ac libero ornare, vestibulum lacus quis blandit enimdicta sunt.</p>
                        </div>
                    </div> <!-- single service -->
                </div>
    ...
    <section id="call-to-action" class="call-to-action pt-60 pb-60 bg_cover" style="background-image: url(assets/images/call-to-action.jpg)">
        <div class="container">
            <div class="row justify-content-center">
    ...
    <section id="block_portfolio" class="portfolio-area pt-60 pb-60">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div id="header_portfolio" class="section-title text-center pb-35">
                        <h2 class="title">Conheça nosso novos temas</h2>
                        <p class="col-lg-8 mx-auto">Nunc id dui at sapien faucibus fermentum ut vel diam. Nullam tempus, nunc id efficitur sagittis, urna est ultricies eros, ac porta sem turpis quis leo.</p> 
                    </div> <!-- section title -->
                </div>
            </div> <!-- row -->
    ...
    <section id="block_doubt" class="duvidas-frequentes pt-60 pb-60">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8">
            ...
            <div class="row justify-content-center" id="content_doubt"></div> <!-- row -->
    ...
    <section id="contact" class="contact-area pt-60 pb-60 gray-bg">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8">
